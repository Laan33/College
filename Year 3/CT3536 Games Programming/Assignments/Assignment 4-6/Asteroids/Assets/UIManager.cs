...
/*
    A simple GUI for displaying in Menu state, which includes a Play button. Clicking the button starts
the game in Playing state.

    A simple GUI for displaying in Playing state, which displays a score, high score, and player lives
*/
