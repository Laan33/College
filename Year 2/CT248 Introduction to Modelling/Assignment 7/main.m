...
% NOTE - I used the official machine learning & statistical plugin from
% matlab from here onwards
% I found nothing saying I couldn't user it, and the alternative code 
% looked to be a mess.
%PART 7
...
% Create the subplot for average delay by month for each origin
for i = 1:3
